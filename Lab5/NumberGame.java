...
class NumberGame
{
      ...
      while(!command.equals("quit"))
      {
         ...
         else if (command.equals("find"))
         {
            ...
            showMenu();
				...
				System.out.println("The Mean is " + numberlist.findMean());
			else if (command.equals("median"))
				System.out.println("The Median is " + numberlist.findMedian());
         else
         {
   ...
   private void showMenu()
   {
      ...
      System.out.println("    find <n>    // search for <n> in the list");
		System.out.println("    mean        // compute and display the average of the numbers in the bag");
		System.out.println("    median      // compute and display the median of the numbers in the bag");
